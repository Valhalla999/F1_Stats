...
class TracksScreen(Screen):
    ...
    def select_circuit(self, circuit ):
        ...
        existing_circuit_label = next((widget for widget in self.layout.children if isinstance(widget, Label) and widget.id == circuit_label_id), None)
    ...
    def select_year(self, year):
        ...
        existing_year_label = next((widget for widget in self.layout.children if isinstance(widget, Label) and widget.id == year_label_id), None)
